...
if (stockCount >= 1) {
    console.log(`I'm going to eat some pie!`)
} else {
    console.log('We need to get some more pie!')
}
...
var vegetables = ['carrots', 'broccoli', 'lettuce', 'brussel sprouts', 'onion']
...
// different fruits.
var fruits = ['strawberry', 'raspberry', 'blackberry', 'blueberry', 'cherry', 'apple', 'orange']
...
// Other key value pairs that would make sense here would be location, is in driving distance, or has bank inside.
